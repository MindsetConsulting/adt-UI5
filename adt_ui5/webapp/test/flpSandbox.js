		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ADT UI5",
									"targetURL": "#mindsetadtui5adtui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mindsetadtui5adtui5-display": {
								"semanticObject": "mindsetadtui5adtui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mindset.adt.ui5.adtui5",
									"url": sap.ui.require.toUrl("mindset/adt/ui5/adtui5")
								}
							}
						}
					}
